...
namespace WindowsFormsApp1gyumolcs
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            listBox_Autok_update();

        }

        private void listBox_Autok_update()
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "INSERT INTO `gyumolcsok`(`darab`, `meret`, `fajta` ,`szin`) VALUES (@db, @meret, @fajta ,@szin)";
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@db", textBox1.Text);
